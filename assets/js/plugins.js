...
!(function (a) {
    ...
    !(function () {
      ...
      (t.prototype.init = function () {
        ...
        var r = 1,
          ...
          a = function () {
            1 < r ? o.core.$outer.addClass("lg-zoomed") : o.resetZoom(),
              e((r = r < 1 ? 1 : r));
          },
          n = !1;
  ...
  (function (t, o, c) {
    ...
    function $(t, e) {
      return (
        t.w
          ? ((t.cWidth = E.calcListLength(e || "100vw")),
            (t.res = t.w / t.cWidth))
          : (t.res = t.d),
        t
      );
    ...
    var r,
      ...
      H =
        /rident/.test(N) ||
        (/ecko/.test(N) && N.match(/rv\:(\d+)/) && 35 < RegExp.$1),
      W = "currentSrc",
      R = /\s+\+?\d+(e\d+)?w/,
      B = /(\([^)]+\))?\s*(.+)/,
      V = t.picturefillCFG,
        ...
        if (M) {
          ...
          if (
            ...
            (s = (e =
              ...
              E.qsa(
                n.context || o,
                n.reevaluate || n.reselect ? E.sel : E.selShort
              )).length))
          ) {
    ...
    function lt() {
      var t = o.readyState || "";
      (b = setTimeout(lt, "loading" === t ? 200 : 999)),
        o.body && (E.fillImgs(), (d = d || v.test(t)) && clearTimeout(b));
    }
    function ct() {
      var t = new Date() - y;
    ...
    function ut() {
      2 === T.width && (E.supSizes = !0),
        (u = E.supSrcset && !E.supSizes),
        (M = !0),
        setTimeout(at);
    }
    t.console && console.warn,
      ...
      (L["image/gif"] = !0),
      (L["image/png"] = !0),
      (L["image/svg+xml"] = o.implementation.hasFeature(
        "http://www.w3.org/TR/SVG11/feature#Image",
        "1.1"
      )),
      (E.ns = ("pf" + new Date().getTime()).substr(0, 9)),
      (E.supSrcset = "srcset" in I),
      (E.supSizes = "sizes" in I),
      (E.supPicture = !!t.HTMLPictureElement),
      E.supSrcset &&
        E.supPicture &&
        !E.supSizes &&
        ...
        (I.srcset = "data:,a"),
        (S.src = "data:,a"),
        (E.supSrcset = I.complete === S.complete),
        (E.supPicture = E.supSrcset && E.supPicture)),
      E.supSrcset && !E.supSizes
        ? ((S =
            "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
          ((T = o.createElement("img")).onload = ut),
          (T.onerror = ut),
      ...
      (E.calcListLength = function (t) {
        ...
        return (
          (t in G && !D.uT) ||
            ((e = E.calcLength(i(t))), (G[t] = e || Z.width)),
          G[t]
        );
      }),
      (E.setRes = function (t) {
        if (t)
          for (var e, i = 0, s = (e = E.parseSet(t)).length; i < s; i++)
            $(e[i], t.sizes);
        return e;
      }),
      (E.setRes.res = $),
      (E.applySetCandidate = function (t, e) {
        if (t.length) {
          var i,
            s,
            n,
            ...
            h =
              ...
              (h = x(
                b,
                (h = !h && b ? (h = v[E.ns].sets) && h[h.length - 1] : h)
              )) &&
                ((b = E.makeUrl(b)),
                (v[E.ns].curSrc = b),
                (v[E.ns].curCan = h).res || $(h, h.set.sizes)),
              h);
          if (
            (h &&
              h.set === t[0].set &&
              ((a = H && !e.complete && h.res - 0.1 > c) ||
      ...
      (E.getSet = function (t) {
        for (var e, i, s = !1, n = t[E.ns].sets, o = 0; o < n.length && !s; o++)
          if (
            (e = n[o]).srcset &&
            E.matchesMedia(e.media) &&
            (i = E.supportsType(e.type))
          ) {
            s = e = "pending" === i ? i : e;
            break;
          }
      ...
      (E.parseSets = function (t, e, i) {
        ...
        (l.src !== c && !i.src) ||
          ((l.src = P.call(t, "src")),
          l.src ? O.call(t, F, l.src) : z.call(t, F)),
          (l.srcset !== c && !i.srcset && E.supSrcset && !t.srcset) ||
            ((s = P.call(t, "srcset")), (l.srcset = s), (r = !0)),
          (l.sets = []),
          a &&
            ((l.pic = !0),
            (function (t, e) {
          ...
          l.srcset
            ? ((n = { srcset: l.srcset, sizes: P.call(t, "sizes") }),
              l.sets.push(n),
              (o = (u || l.src) && R.test(l.srcset || "")) ||
                !l.src ||
                x(l.src, n) ||
                n.has1x ||
                ((n.srcset += ", " + l.src),
          ...
          (l.curCan = null),
          (l.curSrc = c),
          (l.supported = !(a || (n && !E.supSrcset) || (o && !E.supSizes))),
          r &&
            E.supSrcset &&
            !l.supported &&
            (s ? (O.call(t, q, s), (t.srcset = "")) : z.call(t, q)),
          l.supported &&
            !l.srcset &&
            ((!l.src && t.src) || t.src !== E.makeUrl(l.src)) &&
      ...
      (E.fillImg = function (t, e) {
        ...
        t[E.ns] || (t[E.ns] = {}),
          (i = t[E.ns]),
          (!s && i.evaled === a) ||
            ((i.parsed && !e.reevaluate) || E.parseSets(t, t.parentNode, e),
            i.supported
              ? (i.evaled = a)
              : ((e = t),
                (i = E.getSet(e)),
                ...
                "pending" !== i &&
                  ((t = a),
                  i && ((i = E.setRes(i)), E.applySetCandidate(i, e))),
                (e[E.ns].evaled = t)));
      }),
      (E.setupRun = function () {
        (J && !U && X === t.devicePixelRatio) ||
          ((U = !1),
          (X = t.devicePixelRatio),
          (Q = {}),
          (G = {}),
          (E.DPR = X || 1),
          (Z.width = Math.max(t.innerWidth || 0, j.clientWidth)),
          (Z.height = Math.max(t.innerHeight || 0, j.clientHeight)),
          (Z.vw = Z.width / 100),
          (Z.vh = Z.height / 100),
          (a = [Z.height, Z.width, X].join("-")),
          (Z.em = E.getEmValue()),
          (Z.rem = Z.em));
      }),
      E.supPicture
        ? ((at = s), (E.fillImg = s))
        : ((v = t.attachEvent ? /d$|^c/ : /d$|^c|^i/),
          (b = setTimeout(lt, o.body ? 9 : 99)),
          (_ = j.clientHeight),
          n(
            t,
            "resize",
            ((p = function () {
              (U =
                Math.max(t.innerWidth || 0, j.clientWidth) !== Z.width ||
                j.clientHeight !== _),
                (_ = j.clientHeight),
                U && E.fillImgs();
            }),
      ...
      (t.picturefillCFG = {
        ...
        push: function (t) {
          ...
          "function" == typeof E[e]
            ? E[e].apply(E, t)
            : ((D[e] = t[0]), J && E.fillImgs({ reselect: !0 }));
        },
      });
    ...
    (t.picturefill = at),
      ...
      E.supPicture ||
        (L["image/webp"] =
          ...
          ((A = new t.Image()).onerror = function () {
            (L[C] = !1), at();
          }),
          (A.onload = function () {
            (L[C] = 1 === A.width), at();
  ...
  "object" == typeof navigator &&
    (function (t, e) {
      ...
      function c(t) {
        return (
          u(t) ||
          ((d(t) || p(t) || m(t)) && !t.length) ||
          (h(t) && !Object.keys(t).length)
        );
      }
      var s = function (t, e) {
      ...
      const $ = (t) => (null != t ? t.constructor : null),
        ...
        M = (t) =>
          T(t) ||
          ((C(t) || A(t) || E(t)) && !t.length) ||
          (S(t) && !Object.keys(t).length);
      var I = T,
        P = S,
      ...
      function tt(t) {
        F(t) || D(t)
          ? Array.from(t).forEach(tt)
          : q(t) && q(t.parentNode) && t.parentNode.removeChild(t);
      }
      function et(e) {
        if (q(e)) {
      ...
      const ht = {
        ...
        dt = {
          ...
          pip: !(
            U.isIPhone ||
            (!L(K("video").webkitSetPresentationMode) &&
        ...
        setup() {
          if (this.isHTML5) {
            ...
            (a.options.speed = a.config.speed.options),
              B(this.config.ratio) || kt.call(a),
              Object.defineProperty(a.media, "quality", {
                get() {
                  const t = Et.getSources
                    .call(a)
                ...
                set(e) {
                  if (a.quality !== e) {
                    ...
                    vt.call(a, a.media, "qualitychange", !1, { quality: e });
                  }
                },
              });
          }
      ...
      const Ht = {
        getIconUrl() {
          var t =
            ...
            (U.isIE && !window.svg4everybody);
          return { url: this.config.iconUrl, cors: t };
        },
        findElements() {
          try {
            return (
              (this.elements.controls = ct.call(
                this,
              ...
              (this.elements.progress = ct.call(
                this,
        ...
        createIcon(t, e) {
          ...
          Z(o, G(e, { "aria-hidden": "true", focusable: "false" }));
        ...
        createBadge(t) {
          if (B(t)) return null;
          const e = K("span", { class: this.config.classNames.menu.value });
          return (
            e.appendChild(
              K("span", { class: this.config.classNames.menu.badge }, t)
            ),
            e
          );
        },
        createButton(t, e) {
          ...
          switch (
            ...
            Object.keys(i).includes("class")
              ? i.class
                ...
                G(i, { class: `${i.class} ${this.config.classNames.control}` })
          ...
          return (
            n.toggle
              ? (o.appendChild(
                  Ht.createIcon.call(this, n.iconPressed, {
                    class: "icon--pressed",
                  })
                ),
                o.appendChild(
                  Ht.createIcon.call(this, n.icon, {
                    class: "icon--not-pressed",
                  })
                ),
                o.appendChild(
                  Ht.createLabel.call(this, n.labelPressed, {
                    class: "label--pressed",
                  })
                ),
                o.appendChild(
                  Ht.createLabel.call(this, n.label, {
                    class: "label--not-pressed",
                  })
                ))
              : (o.appendChild(Ht.createIcon.call(this, n.icon)),
                o.appendChild(Ht.createLabel.call(this, n.label))),
            G(i, st(this.config.selectors.buttons[s], i)),
            Z(o, i),
            "play" === s
        ...
        createRange(t, e) {
          e = K(
            "input",
            G(
              st(this.config.selectors.inputs[t]),
              {
                type: "range",
                min: 0,
                max: 100,
          ...
          return (
            ...
            Ht.updateRangeFill.call(this, e),
            w.setup(e),
            e
          );
        },
        createProgress(t, e) {
          const i = K(
            "progress",
            G(
              st(this.config.selectors.display[t]),
              {
                min: 0,
                max: 100,
                value: 0,
        ...
        createTime(t, e) {
          (e = st(this.config.selectors.display[t], e)),
            (e = K(
              "div",
              G(e, {
                class: `${e.class || ""} ${
            ...
            (e) => {
              if (
                ...
                if (!i && [32, 39].includes(e.which))
                  Ht.showMenuPanel.call(this, t, !0);
                else {
                  let t;
                  32 !== e.which &&
                    (40 === e.which || (i && 39 === e.which)
                      ? ((t = s.nextElementSibling),
                        q(t) || (t = s.parentNode.firstElementChild))
                      : ((t = s.previousElementSibling),
                        q(t) || (t = s.parentNode.lastElementChild)),
                    ut.call(this, t, !0));
                }
              }
            },
        ...
        createMenuItem({
          ...
          (l.innerHTML = s),
              ...
              set(t) {
                t &&
                  Array.from(a.parentNode.children)
                    .filter((t) => at(t, '[role="menuitemradio"]'))
            ...
            Ht.bindMenuItemShortcuts.call(this, a, i),
            t.appendChild(a);
        },
        formatTime(t = 0, e = !1) {
        ...
        updateVolume() {
          this.supported.ui &&
            (q(this.elements.inputs.volume) &&
              Ht.setRange.call(
                this,
                this.elements.inputs.volume,
                this.muted ? 0 : this.volume
              ),
            q(this.elements.buttons.mute) &&
                  ...
                  (i = this.currentTime),
                    ...
                    (e =
                      0 === i || 0 === s || Number.isNaN(i) || Number.isNaN(s)
                        ...
                        : ((i / s) * 100).toFixed(2)),
                    "timeupdate" === t.type &&
                      Ht.setRange.call(this, this.elements.inputs.seek, e);
                  break;
                case "playing":
                case "progress":
        ...
        updateSeekTooltip(e) {
          if (
            ...
            q(this.elements.inputs.seek) &&
            q(this.elements.display.seekTooltip) &&
            0 !== this.duration
          ) {
        ...
        durationUpdate() {
          if (
            ...
            if (this.duration >= 2 ** 32)
              return (
                nt(this.elements.display.currentTime, !0),
                void nt(this.elements.progress, !0)
              );
            q(this.elements.inputs.seek) &&
            ...
            !t &&
              ...
              Ht.updateSeekTooltip.call(this);
          }
        },
        ...
        updateSetting(t, e, i) {
          ...
          if ("captions" === t) n = this.currentTrack;
            ...
            if (
              ((n = B(i) ? this[t] : i),
              B(n) && (n = this.config[t].default),
              !B(this.options[t]) && !this.options[t].includes(n))
            )
          ...
          if ((q(o) || (o = s && s.querySelector('[role="menu"]')), q(o))) {
            ...
            ).innerHTML = Ht.getLabel.call(this, t, n);
        ...
        setQualityMenu(t) {
          if (q(this.elements.settings.panels.quality)) {
            ...
            if (
              (Ht.toggleMenuButton.call(this, e, t),
              et(i),
              Ht.checkMenu.call(this),
              t)
            ) {
              const s = (t) => {
        ...
        setCaptionsMenu() {
          if (q(this.elements.settings.panels.captions)) {
            const t = "captions",
              ...
              s = Boolean(e.length);
            if (
              (Ht.toggleMenuButton.call(this, t, s),
              et(i),
              Ht.checkMenu.call(this),
              s)
            ) {
              const n = e.map((t, e) => ({
                ...
                badge:
                  t.language &&
                  Ht.createBadge.call(this, t.language.toUpperCase()),
                list: i,
                type: "language",
              }));
              n.unshift({
                ...
                n.forEach(Ht.createMenuItem.bind(this)),
                Ht.updateSetting.call(this, t, i);
            }
          }
        },
        setSpeedMenu() {
        ...
        toggleMenu(e) {
          ...
          if (q(i) && q(s)) {
            ...
            s.setAttribute("aria-expanded", t),
              nt(i, !t),
              ot(this.elements.container, this.config.classNames.menu.open, t),
              t && H(e)
                ? Ht.focusFirstMenuItem.call(this, null, !0)
                : t || n || ut.call(this, s, H(e));
          }
        },
        getMenuSize(t) {
        ...
        create(a) {
          ...
          return (
            wt(D(this.config.controls) ? this.config.controls : []).forEach(
              (e) => {
                ...
                if (
                  ...
                  if (
                    ((q(t) && o.contains(t)) ||
                      ((t = K(
                        "div",
                        G({}, h, { class: `${h.class} plyr__volume`.trim() })
                      )),
                ...
                if (
                  ...
                  "settings" === e && !B(this.config.settings))
                ) {
                  const t = K(
                    "div",
                    G({}, h, {
                  ...
                  const s = K("div", {
                    ...
                    c = K("div"),
                    e = K("div", { id: `plyr-settings-${a.id}-home` }),
                    r = K("div", { role: "menu" });
                  e.appendChild(r),
                    c.appendChild(e),
                    ...
                    this.config.settings.forEach((t) => {
                      const e = K(
                        "button",
                        G(st(this.config.selectors.buttons.settings), {
                          type: "button",
                      ...
                      o.appendChild(
                        K("span", { "aria-hidden": !0 }, jt.get(t, this.config))
                      ),
                        o.appendChild(
                          K(
                            "span",
                            { class: this.config.classNames.hidden },
                            jt.get("menuBack", this.config)
                          )
                        ),
                        gt.call(
                          this,
                        ...
                        gt.call(this, o, "click", () => {
                          u.call(this, "home", !1);
                        }),
                        n.appendChild(o),
                        n.appendChild(K("div", { role: "menu" })),
                        c.appendChild(n),
            ...
            this.isHTML5 && e.call(this, Et.getQualityOptions.call(this)),
            n.call(this),
            o
          );
        },
        inject() {
          ...
          L(this.config.controls) &&
            ...
            q(this.config.controls) || z(this.config.controls)
              ? (e = this.config.controls)
              : ((e = Ht.create.call(this, {
                  id: this.id,
                  seektime: this.config.seekTime,
                  speed: this.speed,
          ...
          if (
            ...
            z(this.config.selectors.controls.container) &&
              (s = document.querySelector(
                this.config.selectors.controls.container
              )),
            q(s) || (s = this.elements.container),
            s[q(e) ? "insertAdjacentElement" : "insertAdjacentHTML"](
              "afterbegin",
              e
            ),
            q(this.elements.controls) || Ht.findElements.call(this),
          ...
          if ((U.isEdge && Y(s), this.config.tooltips.controls)) {
            ...
            Array.from(s).forEach((t) => {
              ot(t, this.config.classNames.hidden, !1),
                ot(t, this.config.classNames.tooltip, !0);
            });
          }
        },
      };
      ...
      const Bt = {
          setup() {
            if (this.supported.ui)
              if (
                !this.isVideo ||
                this.isYouTube ||
                (this.isHTML5 && !dt.textTracks)
              )
                D(this.config.controls) &&
                  this.config.controls.includes("settings") &&
                  this.config.settings.includes("captions") &&
                  Ht.setCaptionsMenu.call(this);
              else {
                var i;
                if (
                  (q(this.elements.captions) ||
                    ((this.elements.captions = K(
                      "div",
                      st(this.config.selectors.captions)
                    )),
                ...
                if (
                  (j(e) || ({ active: e } = this.config.captions),
              ...
              t
                ...
                .forEach((t) => {
                  this.debug.log("Track added", t),
                    ...
                    gt.call(this, t, "cuechange", () =>
                      Bt.updateCues.call(this)
                    );
                }),
              ((o && this.language !== i) || !t.includes(n)) &&
                (Bt.setLanguage.call(this, i), Bt.toggle.call(this, e && o)),
              ot(
              ...
              if (n !== i) {
                if (
                  ...
                  return (
                    ...
                    void Bt.set.call(this, t.indexOf(e))
                  );
                }
                this.elements.buttons.captions &&
                  (this.elements.buttons.captions.pressed = n),
                  ot(this.elements.container, s, n),
                  (this.captions.toggled = n),
                  Ht.updateSetting.call(this, "captions"),
                  vt.call(
                    this,
                    this.media,
          ...
          set(t, e = !0) {
            var i,
              s = Bt.getTracks.call(this);
            -1 !== t
              ? O(t)
                ? t in s
                  ? (this.captions.currentTrack !== t &&
                      ((s = ((i = s[(this.captions.currentTrack = t)]) || {})[
                        "language"
                      ]),
                      ...
                      vt.call(this, this.media, "languagechange")),
                    Bt.toggle.call(this, !0, e),
                    this.isHTML5 && this.isVideo && Bt.updateCues.call(this))
                  : this.debug.warn("Track not found", t)
                : this.debug.warn("Invalid caption argument", t)
              : Bt.toggle.call(this, !1, e);
          },
          setLanguage(t, e = !0) {
            if (z(t)) {
              var i = t.toLowerCase();
          ...
          getLabel(t) {
            ...
            return (
              !W(e) &&
                dt.textTracks &&
                this.captions.toggled &&
                (e = Bt.getCurrentTrack.call(this)),
              W(e)
                ? B(e.label)
                  ? B(e.language)
                    ? jt.get("enabled", this.config)
                    : t.language.toUpperCase()
                  : e.label
                : jt.get("disabled", this.config)
            );
          },
          updateCues(e) {
            if (this.supported.ui)
                ...
                if (I(e) || Array.isArray(e)) {
                  ...
                  if (i !== this.elements.captions.innerHTML) {
                    ...
                    (e.innerHTML = i),
                      ...
                      vt.call(this, this.media, "cuechange");
                  }
      ...
      class Xt {
        constructor(t) {
          o(this, "onChange", () => {
            ...
            o(this, "exit", () => {
              ...
              this.enabled &&
                (U.isIos && this.player.config.fullscreen.iosNative
                  ? (this.target.webkitExitFullscreen(), bt(this.player.play()))
                  : !Xt.native || this.forceFallback
            ...
            (this.player = t),
            (this.prefix = Xt.prefix),
            (this.property = Xt.property),
        ...
        get enabled() {
          return (
            (Xt.native || this.player.config.fullscreen.fallback) &&
        ...
        get active() {
          ...
          if (!Xt.native || this.forceFallback)
            return rt(
              this.target,
              this.player.config.classNames.fullscreen.fallback
            );
      ...
      const Kt = {
        ...
        build() {
          if ((this.listeners.media(), !this.supported.ui))
            return (
              ...
              void Kt.toggleNativeControls.call(this, !0)
            );
          q(this.elements.controls) ||
            (Ht.inject.call(this), this.listeners.controls()),
            Kt.toggleNativeControls.call(this),
            this.isHTML5 && Bt.setup.call(this),
            (this.volume = null),
            (this.muted = null),
            (this.loop = null),
            (this.quality = null),
            (this.speed = null),
            Ht.updateVolume.call(this),
            Ht.timeUpdate.call(this),
            Kt.checkPlaying.call(this),
            ot(
              this.elements.container,
              this.config.classNames.pip.supported,
              dt.pip && this.isHTML5 && this.isVideo
            ),
            ot(
              this.elements.container,
              this.config.classNames.airplay.supported,
              dt.airplay && this.isHTML5
            ),
            ot(this.elements.container, this.config.classNames.isIos, U.isIos),
            ot(
              this.elements.container,
            ...
            Kt.setTitle.call(this),
            this.poster &&
              Kt.setPoster.call(this, this.poster, !1).catch(() => {}),
            this.config.duration && Ht.durationUpdate.call(this);
        },
        setTitle() {
            ...
            : (this.media.setAttribute("data-poster", e),
              ...
              function () {
                return new Promise((t) =>
                  this.ready
                    ? setTimeout(t, 0)
                    : gt.call(this, this.elements.container, "ready", t)
                ).then(() => {});
              }
                .call(this)
                .then(() => Zt(e))
                .catch((t) => {
                  throw (
                    (e === this.poster && Kt.togglePoster.call(this, !1), t)
                  );
                })
                .then(() => {
                  if (e !== this.poster)
          ...
          ot(
            ...
            Array.from(this.elements.buttons.play || []).forEach((t) => {
              Object.assign(t, { pressed: this.playing }),
                t.setAttribute(
                  "aria-label",
                  jt.get(this.playing ? "pause" : "play", this.config)
                );
            }),
        ...
        migrateStyles() {
          Object.values({ ...this.media.style })
            .filter((t) => !B(t) && z(t) && t.startsWith("--plyr"))
            .forEach((t) => {
          ...
          o(this, "firstTouch", () => {
            ...
            o(this, "global", (t = !0) => {
              ...
              e.config.keyboard.global &&
                mt.call(e, window, "keydown keyup", this.handleKey, t, !1),
                mt.call(e, document.body, "click", this.toggleMenu, t),
                yt.call(e, document.body, "touchstart", this.firstTouch),
                mt.call(
                  e,
                  document.body,
            ...
            o(this, "container", () => {
              ...
              !t.keyboard.global &&
                t.keyboard.focused &&
                gt.call(a, l.container, "keydown keyup", this.handleKey, !1),
                gt.call(
                  a,
                  l.container,
                  ...
                  (t) => {
                    ...
                    ["touchstart", "touchmove", "mousemove"].includes(t.type) &&
                      (Kt.toggleControls.call(a, !0),
                      (i = a.touch ? 3e3 : 2e3)),
                      clearTimeout(s.controls),
                      (s.controls = setTimeout(
                        () => Kt.toggleControls.call(a, !1),
                        i
                      ));
                  }
                );
              ...
              gt.call(a, l.container, "enterfullscreen exitfullscreen", (t) => {
                ...
                e === l.container &&
                  ((!a.isEmbed && B(a.config.ratio)) ||
                    (i(),
                    ("enterfullscreen" === t.type ? gt : ft).call(
                      a,
                      window,
                      "resize",
                      n
            ...
            o(this, "media", () => {
              const i = this["player"],
                s = i["elements"];
              if (
                (gt.call(i, i.media, "timeupdate seeking seeked", (t) =>
                  Ht.timeUpdate.call(i, t)
                ),
                gt.call(
                  i,
                  i.media,
                  "durationchange loadeddata loadedmetadata",
                  (t) => Ht.durationUpdate.call(i, t)
                ),
                gt.call(i, i.media, "ended", () => {
                  i.isHTML5 &&
                    i.isVideo &&
                    i.config.resetOnEnd &&
                    (i.restart(), i.pause());
                }),
                gt.call(i, i.media, "progress playing seeking seeked", (t) =>
                  Ht.updateProgress.call(i, t)
                ),
                gt.call(i, i.media, "volumechange", (t) =>
                  Ht.updateVolume.call(i, t)
                ),
                gt.call(
                  i,
                  i.media,
                  "playing play pause ended emptied timeupdate",
                  (t) => Kt.checkPlaying.call(i, t)
                ),
                gt.call(i, i.media, "waiting canplay seeked playing", (t) =>
                  Kt.checkLoading.call(i, t)
                ),
              ...
              gt.call(i, i.media, e, (t) => {
                ...
                "error" === t.type && (e = i.media.error),
                  vt.call(i, s.container, t.type, !0, e);
              });
            }),
            o(this, "proxy", (t, e, i) => {
              const s = this["player"],
            ...
            o(this, "controls", () => {
                    ...
                    [13, 32].includes(e) &&
                      (13 !== e
                        ? (t.preventDefault(),
                          t.stopPropagation(),
                          Ht.toggleMenu.call(r, t))
                        : Ht.focusFirstMenuItem.call(r, null, !0));
                  },
                  null,
                  !1
                ),
              ...
              this.bind(
                ...
                U.isWebkit &&
                  Array.from(lt.call(r, 'input[type="range"]')).forEach((t) => {
                    this.bind(t, "input", (t) =>
                      Ht.updateRangeFill.call(r, t.target)
                    );
                  }),
                r.config.toggleInvert &&
                  !q(s.display.duration) &&
                  this.bind(s.display.currentTime, "click", () => {
                    0 !== r.currentTime &&
                      ((r.config.invertTime = !r.config.invertTime),
                      Ht.timeUpdate.call(r));
                  }),
                this.bind(
                  s.inputs.volume,
                  e,
                ...
                this.bind(s.controls, "focusin", () => {
                  ...
                  ot(s.controls, t.classNames.noTransition, !0),
                    Kt.toggleControls.call(r, !0),
                    setTimeout(() => {
          ...
          if (!(t.altKey || t.ctrlKey || t.metaKey || t.shiftKey) && O(s))
            if (n) {
              ...
              if (q(n)) {
                ...
                if (32 === t.which && at(n, 'button, [role^="menuitem"]'))
                  return;
              }
              switch (
                ([
      ...
      function se(t) {
        t && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
          this.media.paused === t &&
            ((this.media.paused = !t),
            vt.call(this, this.media, t ? "play" : "pause"));
      }
      const ne = {
        setup() {
          const e = this;
          ot(e.elements.wrapper, e.config.classNames.embed, !0),
        ...
        ready() {
          ...
          var a,
            a = B((a = o))
              ? null
              : !O(Number(a)) && a.match(/^.*(vimeo.com\/|video\/)(\d+).*/)
              ? RegExp.$2
              : a;
          const l = K("iframe"),
          ...
          if (
            ...
            B(i) || l.setAttribute("referrerPolicy", i),
            e || !t.customControls)
          )
            l.setAttribute("data-poster", r.poster), (r.media = it(l, r.media));
          else {
            const t = K("div", {
          ...
          t.customControls ||
            Dt(Mt(r.config.urls.vimeo.api, c)).then((t) => {
              !B(t) &&
                t.thumbnail_url &&
                Kt.setPoster.call(r, t.thumbnail_url).catch(() => {});
            }),
            ...
            (r.media.play = () => (se.call(r, !0), r.embed.play())),
            (r.media.pause = () => (se.call(r, !1), r.embed.pause())),
            (r.media.stop = () => {
          ...
          Object.defineProperty(r.media, "loop", {
            ...
            r.embed.on("timeupdate", (t) => {
              (r.media.seeking = !1),
                (u = t.seconds),
                vt.call(r, r.media, "timeupdate");
            }),
            r.embed.on("progress", (t) => {
              (r.media.buffered = t.percent),
                vt.call(r, r.media, "progress"),
                1 === parseInt(t.percent, 10) &&
                  vt.call(r, r.media, "canplaythrough"),
                r.embed.getDuration().then((t) => {
                  t !== r.media.duration &&
                    ((r.media.duration = t),
                    vt.call(r, r.media, "durationchange"));
                });
            }),
            r.embed.on("seeked", () => {
      ...
      const re = {
          setup() {
            if (
              (ot(this.elements.wrapper, this.config.classNames.embed, !0),
              P(window.YT) && L(window.YT.Player))
            )
              re.ready.call(this);
            else {
          ...
          getTitle(t) {
            Dt(Mt(this.config.urls.youtube.api, t))
              .then((t) => {
                var e, i;
                P(t) &&
            ...
            if (B(t) || !t.startsWith("youtube-")) {
              ...
              if (((o.media = it(e, o.media)), r.customControls)) {
                ...
                Zt(r("maxres"), 121)
                  .catch(() => Zt(r("sd"), 121))
                  .catch(() => Zt(r("hq")))
                  .then((t) => Kt.setPoster.call(o, t.src))
                  .then((t) => {
                    t.includes("maxres") ||
                ...
                events: {
                  ...
                  onPlaybackRateChange(t) {
                    ...
                    (o.media.playbackRate = e.getPlaybackRate()),
                      vt.call(o, o.media, "ratechange");
                  },
                  onReady(t) {
                    if (!L(o.media.play)) {
                      const s = t.target;
                      re.getTitle.call(o, a),
                        (o.media.play = () => {
                      ...
                      Object.defineProperty(o.media, "volume", {
                        ...
                        set(t) {
                          (e = t),
                            s.setVolume(100 * e),
                            vt.call(o, o.media, "volumechange");
                        },
                      });
                      ...
                      (o.options.speed = n.filter((t) =>
                        ...
                        vt.call(o, o.media, "durationchange"),
                        ...
                        (o.timers.buffering = setInterval(() => {
                          (o.media.buffered = s.getVideoLoadedFraction()),
                            (null === o.media.lastBuffered ||
                              ...
                              vt.call(o, o.media, "progress"),
                            (o.media.lastBuffered = o.media.buffered),
                            1 === o.media.buffered &&
                              (clearInterval(o.timers.buffering),
                              vt.call(o, o.media, "canplaythrough"));
                        }, 200)),
                        r.customControls &&
                          setTimeout(() => Kt.build.call(o), 50);
                    }
                  },
                  onStateChange(t) {
                    const e = t.target;
                    switch (
                      ...
                      o.media.seeking &&
                        [1, 2].includes(t.data) &&
                        ((o.media.seeking = !1), vt.call(o, o.media, "seeked")),
                      t.data)
                    ) {
                      case -1:
                        vt.call(o, o.media, "timeupdate"),
            ...
            this.media
              ? (ot(
                ...
                this.isHTML5
                  ...
                  : this.isYouTube
                  ? re.setup.call(this)
                  : this.isVimeo && ne.setup.call(this))
      ...
      class le {
        ...
        get tagUrl() {
          ...
          return R(t.tagUrl)
            ? t.tagUrl
            : `https://go.aniview.com/api/adserver6/vast/?${Rt({
        ...
        constructor(t) {
          o(this, "load", () => {
            ...
            o(this, "startScrubbing", (t) => {
              (!I(t.button) && !1 !== t.button && 0 !== t.button) ||
                ((this.mouseDown = !0),
                this.player.media.duration &&
            ...
            o(this, "render", () => {
              ...
              (this.elements.thumb.time = K("span", {}, "00:00")),
                ...
                q(this.player.elements.progress) &&
            ...
            o(this, "setScrubbingContainerSize", () => {
              var { width: t, height: e } = ce(this.thumbAspectRatio, {
              ...
              this.destroy.call(
                ...
                () => {
                  (this.options.quality = []),
                    tt(this.media),
                    (this.media = null),
                    q(this.elements.container) &&
                      this.elements.container.removeAttribute("class");
                  var { sources: t, type: e } = o,
                    [{ provider: i = Ut.html5, src: s }] = t,
                    n = "html5" === i ? e : "div",
                    s = "html5" === i ? {} : { src: s };
                  Object.assign(this, {
                    provider: i,
                    ...
                    j(o.autoplay) && (this.config.autoplay = o.autoplay),
                    this.isHTML5 &&
                      (this.config.crossorigin &&
                        this.media.setAttribute("crossorigin", ""),
                      this.config.autoplay &&
                        this.media.setAttribute("autoplay", ""),
                      B(o.poster) || (this.poster = o.poster),
                      this.config.loop.active &&
                        this.media.setAttribute("loop", ""),
                      this.config.muted && this.media.setAttribute("muted", ""),
                      this.config.playsinline &&
                        this.media.setAttribute("playsinline", "")),
                    Kt.addStyleHook.call(this),
                    ...
                    B(o.previewThumbnails) ||
                      ...
                      this.config.previewThumbnails.enabled &&
                        (this.previewThumbnails = new ue(this))),
      ...
      class de {
        constructor(t, e) {
          if (
            ...
            o(this, "togglePlay", (t) =>
              (j(t) ? t : !this.playing) ? this.play() : this.pause()
            ),
            o(this, "stop", () => {
              this.isHTML5
            ...
            o(this, "toggleControls", (t) => {
              ...
              if (
                (t &&
                  D(this.config.controls) &&
                  this.config.controls.includes("settings") &&
                  !B(this.config.settings) &&
                  Ht.toggleMenu.call(this, !1),
                t !== e)
              ) {
            ...
            o(this, "destroy", (t, e = !1) => {
              ...
              this.ready &&
                  ...
                  (document.body.style.overflow = ""),
                    ...
                    e
                      ? (Object.keys(this.elements).length &&
                          (tt(this.elements.buttons.play),
                          tt(this.elements.captions),
                          tt(this.elements.controls),
                          tt(this.elements.wrapper),
                      ...
                      : (function () {
                        ...
                        Et.cancelRequests.call(this),
                        it(this.elements.original, this.elements.container),
                        vt.call(this, this.elements.original, "destroyed", !0),
                ...
                this.isHTML5
                  ? (Kt.toggleNativeControls.call(this, !0), i())
                  : this.isYouTube
            ...
            o(this, "supports", (t) => dt.mime.call(this, t)),
            (this.timers = {}),
            (this.ready = !1),
            (this.loading = !1),
            (this.failed = !1),
            ...
            (this.debug = new Gt(this.config.debug)),
            this.debug.log("Config", this.config),
            this.debug.log("Support", dt),
            !I(this.media) && q(this.media))
          )
              ...
              if (dt.check().api) {
                ...
                switch (s) {
                  case "div":
                    ...
                    if (
                      B(this.provider) ||
                      !Object.values(Ut).includes(this.provider)
                    )
                ...
                (this.supported = dt.check(
                  ...
                  this.supported.api
                    ? ((this.eventListeners = []),
                      (this.listeners = new Jt(this)),
                      (this.storage = new Lt(this)),
                      (this.media.plyr = this),
                      q(this.elements.container) ||
                        ((this.elements.container = K("div", { tabindex: 0 })),
                        X(this.media, this.elements.container)),
                      Kt.migrateStyles.call(this),
                      Kt.addStyleHook.call(this),
                      ae.setup.call(this),
                      this.config.debug &&
                        gt.call(
        ...
        set volume(t) {
          ...
          z(e) && (e = Number(e)),
            ...
            (this.media.volume = e),
            !B(t) && this.muted && 0 < e && (this.muted = !1);
        }
        get volume() {
        ...
        set muted(t) {
          let e = t;
          j(e) || (e = this.storage.get("muted")),
            j(e) || (e = this.config.muted),
            (this.config.muted = e),
            (this.media.muted = e);
        }
        get muted() {
        ...
        set download(t) {
          R(t) &&
            ((this.config.urls.download = t), Ht.setDownloadUrl.call(this));
        }
        set poster(t) {
          this.isVideo
            ? Kt.setPoster.call(this, t, !1).catch(() => {})
        ...
        set ratio(t) {
          this.isVideo
            ? z(t) && Tt(t)
              ? ((this.config.ratio = St(t)), kt.call(this))
        ...
        set pip(t) {
          dt.pip &&
            ...
            L(this.media.webkitSetPresentationMode) &&
              this.media.webkitSetPresentationMode(t ? Yt : "inline"),
        ...
        get pip() {
          return dt.pip
            ? B(this.media.webkitPresentationMode)
              ? this.media === document.pictureInPictureElement
              : this.media.webkitPresentationMode === Yt
            : null;
        }
        ...
        function A() {
          ...
          for (
            ...
            var e = void 0,
              ...
              w = !0;
            o || r || a || l ? (e = { xs: o, sm: r, md: a, lg: l }) : (w = !1),
              (o = _.options.wrapper
